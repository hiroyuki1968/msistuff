...
////////////////////////////        012345678
TCHAR rgszCommandOptions[]= TEXT("udnviawpmocej");
//////////////////////////        0123456789012
...
/* Operation               */ ISETUPPROPNAME_OPERATION,
/* Copy Package            */ ISETUPPROPNAME_COPYPACKAGE,
/* Exe Name                */ ISETUPPROPNAME_EXENAME,
/* InstJet                 */ ISETUPPROPNAME_INSTJET
};
...
TCHAR rgchResSwitch[] ={TEXT('u'),TEXT('d'),TEXT('n'),TEXT('v'),TEXT('i'),TEXT('a'),TEXT('w'),TEXT('p'),TEXT('m'),TEXT('o'),TEXT('c'),TEXT('e'),TEXT('j')};
...
//                                        TEXT(" Windows Installer Update            - /w {value} \n")
                                        ...
                                        TEXT(" Copy Package                        - /e 1 \n")
                                        TEXT(" Exe Name                            - /j {value} \n")
                                        TEXT(" InstJet                             - /k 1 \n")
                                        TEXT("\n")
